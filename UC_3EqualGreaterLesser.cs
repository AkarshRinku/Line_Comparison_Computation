...
namespace LineComparison
{
    class UC_3EqualGreaterLesser
    {
        public static void Cartesian()
        {
            ...
            {
                Console.WriteLine("The length of the Line1 is lesser than Line2");
            }
            else if (length1 > length2)
            {
                Console.WriteLine("The length of the Line1 is greater than Line2");
            }
        }
    }
